...
A diferencia de la norma ISDB-Tb tradicional, el nuevo esquema exige un nuevo aparato para soportar el \emph{streaming} de contenidos a través de una red IP. A su vez, aparece la nueva responsabilidad de regular la emisión a través de un grupo multicast y la construcción de estructuras de señalización al momento de multiplexación de servicios.

Para las pruebas se utiliza un esquema similar al de la \cref{fig:test_scheme}
