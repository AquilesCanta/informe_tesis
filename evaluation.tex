...
% Este capÃ­tulo plantea pruebas a realizar sobre el prototipo desarrollado, resultados esperados y obtenidos de las mismas.
...
% Closed caption
% CÃ³mo se comportarÃ­a el acceso condicional con el esquema extendido
