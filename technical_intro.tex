...
\begin{figure}[H]
\begin{center}
\includegraphics[width=15cm]{imgs/decoder.png}
\caption{Modelo de un receptor ISDB-Tb}
\end{center}
\end{figure}


% Siendo un estándar abierto, existen varias implementaciones. \textbf{Lifia} lleva adelante el desarrollo del reproductor de televisión digital \textbf{Wari}.

% \emph{Wari} es un reproductores de Kuntur que fue ideado para utilizarse en computadoras personales. Al igual que el resto de los reproductores de Kuntur, Wari utiliza la librería \textbf{mpeg-parser}, también incluida en el proyecto, para la captura y decodificación del formato de flujo de transporte.
