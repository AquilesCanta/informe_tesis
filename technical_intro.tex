...
El proceso de multiplexación de servicios de acuerdo al formato MPEG-TS debe seguir estrictos lineamientos. Por ejemplo, si se volcara todo el contenido y se analizara, se encontraría el byte de sincronización cada 188 bytes. También, muchos de los paquetes encontrados serían nulos, que sirven para completar el bitrate que ofrece el medio y que no se puede completar con contenido real. 

El proceso de construcción posee los siguientes pasos:

\begin{enumerate}
\item Definir servicios de acuerdo a bitrate, que a su vez es de acuerdo a los parámetros de modulación
\item  sacar Flujos
\item Pes
\item Paquetes Pes
\item tablas
