...
Para ejemplificar, un fragmento de la señal emitida por la frecuencia 527 de la Televisión Digital Abierta argentina[TODO: Agregar cita de tda] presenta 3 servicios. TV Públic HD, Tecnópolis y TV Pública con videos HD, SD y LD respectivamente. El bitrate promedio para estos videos es 11.7, 2.0 y 0.3.
...
\subsection{MPEG-TS}
 ...
 El flujo multiplexado de servicios que viaja por un canal físico de radiofrecuencia en el estándar ISDB-Tb respeta el formato \textbf{MPEG-2 Transport Stream} o \emph{flujo de transporte}, o simplemente \textbf{MPEG-TS}. Los receptores de televisión digital terrestre en Argentina deben adoptar estas normas para demultiplexar, procesar y entregar los servicios al usuario.

\subsection{Estructura general del sistema \textbf{MPEG-TS}}

El sistema \textbf{MPEG-TS} se puede dividir jerárquicamente de la siguiente manera:
