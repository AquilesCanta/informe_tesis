...
El proceso de reproducción de flujos elementales, por el contrario, comienza una vez se dispone de los flujos elementales reconstruidos. Consiste en decodificarlos y obtener las imagenes o el audio que componen al servicio. En Wari, este proceso es realizado por algún reproductor existente. Sin embargo, el reproductor debe tener forma de acceder a estos flujos elementales.
...
\begin{itemize}
	\item Algo algo
	\item otra cosa Como miera hace el player para poner los demuxers. Averiguar
\end{itemize}
