...
El proceso de recepción, decodificación y reproducción de los servicios de un flujo de transporte es extenso y complejo. Para analizarlo, se usará como base el reproductor \emph{Wari}. 

\emph{Wari} es un reproductor de televisión digital en la norma ISDB-Tb ideado para utilizarse en computadoras personales. Es actualmente desarrollado y mantenido por Lifia[TODO: ¿Insertar cita o algo?], aunque es de código abierto.
