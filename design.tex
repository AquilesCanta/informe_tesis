...
Si los paquetes del flujo de transporte se enviaran al ritmo máximo que permitiera la infraestructura, el receptor eventualmente sufriría un \emph{overflow}. Además, es deseable aprovechar la máxima unidad de transmisión permitida por la red (tamaño máximo permitido de un datagrama, ejemplo: 1500 \emph{bytes} en \emph{Ethernet}), para minimizar el \emph{overhead} generado por el proceso de \emph{routing} y los \emph{headers} de los datagramas. 
