...
El \cref{lst:desccapture} es utilizado en Mara para obtener una instancia del \emph{Service Elementaries Relocation Descriptor} a partir del flujo de transporte sintonizado. [TODO: Arrglar el pedazo de codigo para que las variables coincidan con los diagramas (y ulteriormente con el codigo).] El macro \texttt{DESC\_PARSE( descriptors, elementaries_relocation, d)} genera la invocación del \emph{parser} del descriptor, incluido en el \cref{lst:descparse}.
