...
El objetivo de este capítulo es explicar el diseño de un sistema de entrega de televisión digital que integra broadcast ISDB-T e IPTV. El sistema se divide en tres partes:

\begin{itemize}
	\item Extensión de ISDB-T
	\item Diseño y desarrollo de un prototipo de recepción del sistema combinado.
	\item Implementación de emisión IPTV.
\end{itemize}

\section{Señalización y distribución de servicios}

El primer paso para combinar los sistemas de transmisión es definir qué servicios viajan por qué medio e indicar esto a los dispositivos de recepción. Llamaremos \emph{señalización} a la entrega de información sobre los servicios para la construcción de la lista y su reproducción. 
...
El primer punto es agregar una extensión al flujo de transporte. Esta extensión tiene el objetivo de posibilitar la indicación al receptor de la existencia de un servicio cuyos flujos elementales deben ser obtenidos por medio de una red IP, en emisión multicast.
...
Siguiendo el segundo de los principios de diseño \textbf{SOLID}(\emph{Open/Closed Principle}), es importante para este desarrollo evitar modificar el formato MPEG-TS tanto como sea posible, sino extenderlo. Entonces, se busca agregar los comportamientos por medio de entidades nuevas en lugar de modificar las ya existentes.

Para señalizar nuevos servicios cuyos flujos elementales se deben obtener desde una red IP, definiremos un nuevo descriptor de acuerdo al formato \textbf{MPEG-TS}. Lo llamaremos \emph{Elementaries Relocation Descriptor}. 
...
\hline 
\end{tabular}
\caption{Sintaxis del \emph{Elementaries Relocation Descriptor}\label{tab:descsyntax}}
\end{center}
\end{table}
...
A partir de los \pid\ filtrado, las clases de demultiplexación construyen un URL de reproducción. Cuando se halla el \emph{Elementaries Relocation Descriptor}, esta URL debe ser reemplzada por la obtenida desde el descriptor.
