...
Algunas de las características principales del formato MPEG-TS incluyen:

\begin{itemize}
	\item Multiplexación de servicios.
	\item Tolerancia a pérdidas y fallos de transmisión.
	\item Mecanismos de sincronización de audio y video.
	\item Formato extensible.
	\item Mecanismos de sincronización de comienzo de paquetes.
\end{itemize}
...
Para poner en funcionamiento el sistema se debe modular el flujo de transporte en radiofrecuencia, emitir los flujos elementales por los grupos multicast y puertos adecuados, y consumir todo desde un software de recepción. A continuación se introduce \emph{Mara}, una modificación de \emph{Wari} que es capaz de utilizar el \emph{Service Elementaries Relocation Descriptor}. 
